...
#define HOTSPOT_WIFI  "Zamora"            /* Nombre del punto de acceso a conectarse */
#define HOTSPOT_PWD   "Zamora12345"                       /* Contraseña de la red */
//#define HOTSPOT_WIFI  "INFINITUMA228"            /* Nombre del punto de acceso a conectarse */
//#define HOTSPOT_PWD   "Qp6Ca9Qk9j"                       /* Contraseña de la red */
#define MQTT_SERVER   "test.mosquitto.org"     /* Dirección del Broker MQTT */
#define MQTT_PORT     1883                     /* Puerto del Broker MQTT */
#define TXTOPIC       "/SEIoT/TX_TESTS"         /* Nombre del topic de publicación */
...
void MQTT :: publish_MQTT ( void ) {
  ...
  //String hola = " ";
    ...
    client.publish( TXTOPIC,  "oa");                 /* Función librería PubsubClient */
